...
<head>
    ...
    <link rel="stylesheet" href="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/css/battle.css">
    <style>
...
<div class="app" id="app" style="background-size: cover; background-position: center;">
    ...
    <div class="top-bar">
        <div class="user-info">
            <img id="userAvatar" class="user-avatar" src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'" onclick="showAvatarModal()">
                    ...
                    <div id="ownPalaceInfo">
                        ...
                        <div id="occupierDisplay">
                            <div style="display:flex; align-items:center; gap:10px; margin:10px 0;">
                                <img id="occupierAvatar" src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png" style="width:45px; border-radius:50%;" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'">
    ...
    <div id="friendPanel" class="friend-panel" style="display:none;">
        ...
        <div style="max-height:400px; overflow-y:auto; margin-top:10px;">
            <div class="friend-item self-item"><div style="display:flex; align-items:center; gap:10px;"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png" class="friend-avatar" id="selfAvatar" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'"><span style="font-weight:bold;">我（<span id="selfName"></span>）</span></div><button onclick="soloPracticeFromFriend()" style="background:#5a7a5a;">🏋️ 自我切磋</button></div>
...
<script src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/js/battle.js"></script>
<script>
// ========== 全局变量 ==========
let ws = null;
        ...
        try {
            ...
            if (data.heroes) {
                for (const hero of data.heroes) {
                    urls.add(`https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${hero.id}.png`);
                    urls.add(`https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${hero.id}_attack.png`);
                    urls.add(`https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${hero.id}_hit.png`);
                }
            }
        } catch(e) { console.warn('获取武将列表失败', e); }
    }
    const bgList = ['https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_jinao.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_sanxian.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/lianxianzhen.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/bagualu.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/biyougong.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/wanxiandian.jpg','https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/battle_bg.jpg'];
    for (const bg of bgList) urls.add(bg);
    const gemList = ['strength.png','intelligence.png','speed.png','hp.png','double.png'];
    for (const gem of gemList) urls.add(`https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/gems/${gem}`);
    urls.add('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png');
    urls.add('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png');
...
function setBackgroundByTab(tab) {
    let bgUrl = '';
    switch (tab) { case 'map': bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_jinao.jpg'; break; case 'formation': bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/lianxianzhen.jpg'; break; case 'gems': bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/bagualu.jpg'; break; case 'city': bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/biyougong.jpg'; break; case 'recruit': bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/wanxiandian.jpg'; break; default: bgUrl = ''; }
...
function updateChallengeBackground() {
    ...
    let bgUrl = '';
    if (selectedId === 'jinao') bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_jinao.jpg';
    else if (selectedId === 'sanxian') bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_sanxian.jpg';
    else if (selectedId === 'yuxu') bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_kunlun.jpg';
    else if (selectedId === 'bajing') bgUrl = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/bg/challenge_kongtong.jpg';
    if (bgUrl) setCachedBackground(bgUrl);
}
...
async function loadUserAvatar() { let r = await fetch(`/user_info?username=${currentUser}`); let d = await r.json(); if (d.success && d.avatar) document.getElementById('userAvatar').src = `https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${d.avatar}`; else document.getElementById('userAvatar').src = 'https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'; }
...
async function loadChallengeNodes(challengeId) {
    ...
    for (let i = 0; i < nodes.length; i++) {
        ...
        for (let hid of (n.main_hero_ids || [])) 
            heroAvatars += `<img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${hid}.png" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png'" style="width:40px; height:40px; border-radius:50%; margin:2px; border:1px solid gold;">`;
...
function renderFormationGrid() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        else if (hero) { let heroId = heroIdMap[hero.name] || hero.name; slotDiv.innerHTML = `<div class="formation-hero"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${heroId}.png" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png'"><div class="formation-hero-name">${hero.name}</div></div>`; slotDiv.onclick = () => removeFromFormation(i); }
...
async function selectHeroForSlot(realPosition) {
    ...
    modal.innerHTML = `<div class="modal-content"><h3>选择武将</h3><div class="gem-grid" id="heroSelectList">${heroes.map(h => `<div class="hero-card" data-name="${h.name}" data-id="${h.id}"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${h.id}.png" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png'"><div>${h.name}</div><div>Lv.${h.level} ★${h.star}</div></div>`).join('')}</div><button onclick="this.parentElement.parentElement.remove()">取消</button></div>`;
...
async function loadGems() {
    ...
    items.forEach(g => {
        ...
        div.innerHTML = `<div style="display:flex; flex-direction:column; align-items:center;"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/gems/${iconFile}" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/gems/gem.png'" style="width:40px; height:40px; object-fit:contain;"><strong style="font-size:12px;">${nameText}</strong><span style="font-size:11px;">${detailText}</span><span style="font-size:10px;">数量: ${g.count}</span><button class="discard-gem-btn" data-id="${g.id}" style="margin-top:4px; padding:2px 8px; font-size:11px; background:#8a5a5a;">🗑️ 丢弃</button></div>`;
...
async function selectGemForSlot(heroName, slot) {
    ...
    for (let g of gems) {
        ...
        gemsHtml += `<div class="gem-card" data-id="${g.id}" style="cursor:pointer;"><div style="display:flex; flex-direction:column; align-items:center;"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/gems/${iconFile}" style="width:48px; height:48px; object-fit:contain;" onerror="this.style.display='none'"><strong style="font-size:12px;">${nameText}</strong><span style="font-size:11px;">★${g.star} +${g.value}</span><span style="font-size:10px;">数量: ${g.count}</span></div></div>`;
    }
    gemsHtml += '</div>';
...
async function loadCityInfo() {
    ...
    if (occd.occupier) { let occUser = await fetch(`/user_info?username=${occd.occupier}`); let occUserData = await occUser.json(); document.getElementById('occupierName').innerHTML = `<strong>${occd.occupier}</strong> (占领者)`; document.getElementById('occupierAvatar').src = `https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${occUserData.avatar || 'hero.png'}`; document.getElementById('selfReleaseBtn').style.display = 'inline-block'; }
    else { document.getElementById('occupierName').innerHTML = '未被占领'; document.getElementById('occupierAvatar').src = `https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${d.avatar || 'hero.png'}`; document.getElementById('selfReleaseBtn').style.display = 'none'; }
...
async function loadBranchList() {
    ...
    for (let b of d.list) {
        html += `<div class="branch-card" data-friend="${b.name}">
            <img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${b.avatar}" style="width:40px;border-radius:50%;cursor:pointer;" onclick="visitFriendPalace('${b.name}')" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png'">
...
// ========== 访问好友碧游宫和万仙殿 ==========
async function visitFriendPalace(friendName) { let existingModal = document.querySelector('.modal'); if (existingModal) existingModal.remove(); let r = await fetch(`/friend_palace_info?username=${currentUser}&friend=${friendName}`); let d = await r.json(); if (!d.success) { alert(d.msg || "无法获取好友碧游宫信息"); return; } let modal = document.createElement('div'); modal.className = 'modal'; modal.innerHTML = `<div class="modal-content" style="text-align:center;"><h3>🏯 ${friendName} 的碧游宫</h3><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${d.avatar}" style="width:80px; border-radius:50%; margin:10px auto; display:block;" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'"><p>🌟 等级: ${d.level}</p><p>👑 占领者: ${d.occupier || '无'}</p><p>📜 分舵数量: ${d.branches}</p><button onclick="this.closest('.modal').remove()" style="margin-top:15px;">关闭</button></div>`; document.body.appendChild(modal); }
async function viewFriendRecruit(friendName) {
    ...
    else { for (let [name, info] of Object.entries(d.shop)) { shopHtml += `<div class="recruit-card" data-name="${name}"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/${info.hero_id}.png" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/heroes/hero.png'"><div>${name}</div><div>★${info.star}</div><div>💰${info.cost}</div><button class="hire-from-occupied" data-name="${name}">招募</button></div>`; } }
    shopHtml += '</div>';
...
function renderFriendList() { let container = document.getElementById('friendListContainer'); let noMsg = document.getElementById('noFriendsMsg'); if (!container) return; if (friendsList.length === 0) { container.innerHTML = ''; noMsg.style.display = 'block'; return; } noMsg.style.display = 'none'; container.innerHTML = ''; let displayFriends = friendsList.slice(0,50); for (let f of displayFriends) { let div = document.createElement('div'); div.className = 'friend-item'; div.innerHTML = `<div style="display:flex; align-items:center; gap:8px; flex:1; cursor:pointer;" onclick="showFriendActions('${f.name}')"><img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${f.avatar || 'hero.png'}" class="friend-avatar" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'"><div><div class="friend-name">${f.name}</div><div class="friend-status">${f.online ? '🟢 在线' : '⚫ 离线'}</div></div></div><div class="friend-actions"><button onclick="showFriendActions('${f.name}')">📋</button></div>`; container.appendChild(div); } }
async function setSelfInfo() { let r = await fetch(`/user_info?username=${currentUser}`); let d = await r.json(); if (d.success) { document.getElementById('selfName').innerText = currentUser; document.getElementById('selfAvatar').src = `https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${d.avatar}`; } }
...
async function showAvatarModal() {
    ...
    for (let av of d.avatars) {
        ...
        div.innerHTML = `<img src="https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${av}" style="width:60px; height:60px; border-radius:50%; border:2px solid gold; object-fit:cover;" onerror="this.src='https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/hero.png'">`;
...
async function selectAvatar(avatar) {
    ...
    let d = await r.json();
    if (d.success) {
        document.getElementById('userAvatar').src = `https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/images/avatars/${avatar}`;
        closeAvatarModal();
        setSelfInfo();
        addLog("👤 头像已更换");
    }
...
function initMusic() {
    bgMusic = new Audio('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/music/bg01.mp3'); bgMusic.loop = true; bgMusic.volume = 0.7;
    battleMusic = new Audio('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/music/battle.mp3'); battleMusic.loop = true; battleMusic.volume = 0.7;
    winSound = new Audio('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/music/fightwin.mp3'); winSound.loop = false; winSound.volume = 0.7;
    loseSound = new Audio('https://testingcf.jsdelivr.net/gh/jiejiaogame/jiejiao/static/music/fightlose.mp3'); loseSound.loop = false; loseSound.volume = 0.7;
